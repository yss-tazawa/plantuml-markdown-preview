...
- **단독 다이어그램 미리보기** — Markdown 래퍼 없이 `.puml`, `.mmd`, `.d2` 파일을 직접 열어 이동 및 확대/축소, 실시간 업데이트, 테마 지원을 제공합니다.
...
| 도구 | 용도 | 확인 |
|------|---------|--------|
| [Java 11+ (JRE 또는 JDK)](#설정-1) | PlantUML 실행 (포함된 PlantUML 1.2026.2는 Java 11+ 필요) | `java -version` |
