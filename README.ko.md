...
- **반응형** 모드 및 **픽셀 너비 프리셋** (640–1440px), 가운데 또는 왼쪽 정렬
...
| Responsive | 사용자 설정 배율; 넘치는 다이어그램은 축소됨 |
| 640px – 1440px | 픽셀 단위 고정 본문 너비 |
| Responsive (Left-Aligned) | Responsive와 동일하지만 왼쪽 정렬 |
